...
There is some low positive correlation between the mass concentration and the TPM. However, there is one clear outlier, one point with very high TPM and low concentration based on the day - `SIRV618` day 0 and `SIRV311` day 5. For day 0 rep 2 `SIRV311` is an additional outlier. 
...
There is low correlation between the mass concentration and TPM between concentration and TPM. 
...
There is no apparent correlation between the TPM for Salmon and Bambu. The results are similar for all of the NDR thresholds. 
...
We expected correlation between the concentrations of the spike-ins and the corresponding TPMs. For Illumina+Salmon data low positive correlation could be observed between the concentrations and the TPMs except for one or two evident outliers. The correlation was also low and positive for PacBio+Bambu data. There was no apparent correlation between the TPM for Salmon and Bambu. The results were similar for all of the NDR thresholds. The spike-ins represent the controls of the experiment and the lack of correlation in the data possibly reflects some errors in experimental procedures or data preprocessing. 

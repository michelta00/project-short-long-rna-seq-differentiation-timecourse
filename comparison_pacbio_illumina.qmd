...
```{r}
#Histograms of differences (only always performed on first column) 
...
sums_df <- data.frame(
  Range = c("0-1000", "1000-2000", "2000-3000", "3000-4000", "4000-5000",
...
## Salmon 0.025
y_salmon_0.025 <- DGEList(counts = salmon_0.025, group = group)
...
## Bambu 0.025
y_bambu_0.025 <- DGEList(counts = bambu_0.025, group = group)
...
## Salmon 0.05
y_salmon_0.05 <- DGEList(counts = salmon_0.05, group = group)
...
## Bambu 0.05
y_bambu_0.05 <- DGEList(counts = bambu_0.05, group = group)
...
## Salmon 0.1
y_salmon_0.1 <- DGEList(counts = salmon_0.1, group = group)
...
## Bambu 0.1
y_bambu_0.1 <- DGEList(counts = bambu_0.1, group = group)
...
## Salmon 0.2
y_salmon_0.2 <- DGEList(counts = salmon_0.2, group = group)
...
## Bambu 0.2
y_bambu_0.2 <- DGEList(counts = bambu_0.2, group = group)
...
```
#aufsummieren spalten
#beispiel aus lösungen 
